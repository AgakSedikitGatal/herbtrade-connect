...
const ordersData: Order[] = [
  { id: '0x8f4e3a2b', product: 'Jahe', customer: 'Matt Dickerson', date: '13/05/2022', amount: '90 USD', payment: 'Bank Transfer', status: 'Delivered' },
  { id: '0x2c7a8d1f', product: 'Kunyit', customer: 'Wiktoria', date: '22/05/2022', amount: '150 USD', payment: 'Bank Transfer', status: 'Delivered' },
  { id: '0x5b9d1e4a', product: 'Jahe', customer: 'Trixia Raya', date: '15/06/2022', amount: '200 USD', payment: 'E-Wallet', status: 'Process' },
  { id: '0x9e3c7f2b', product: 'Kayu Manis', customer: 'Jamie Morrison', date: '08/05/2022', amount: '80 USD', payment: 'E-Wallet', status: 'Delivered' },
  { id: '0x1a7f4c9e', product: 'Lada Hitam', customer: 'Robert Levy', date: '30/04/2022', amount: '120 USD', payment: 'Bank Transfer', status: 'Canceled' },
  { id: '0x3d8b2f5c', product: 'Pala', customer: 'Noel Baldwin', date: '15/04/2022', amount: '95 USD', payment: 'E-Wallet', status: 'Delivered' },
  { id: '0x6e2a9c4d', product: 'Jahe', customer: 'Zaire Saris', date: '22/03/2022', amount: '110 USD', payment: 'Bank Transfer', status: 'Delivered' },
  { id: '0x7f1c3a8e', product: 'Kunyit', customer: 'Michael Jenkins', date: '03/03/2022', amount: '75 USD', payment: 'E-Wallet', status: 'Delivered' },
  { id: '0x4b9e1d7f', product: 'Kayu Manis', customer: 'Tyler Moran', date: '01/02/2022', amount: '140 USD', payment: 'Bank Transfer', status: 'Delivered' },
  { id: '0x2c8d5a6b', product: 'Lada Hitam', customer: 'Liam Melon', date: '19/01/2022', amount: '160 USD', payment: 'E-Wallet', status: 'Delivered' }
];
